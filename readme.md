...
1.  1st assignment* (corresponding to Block I) due to December 13th. For questions, contact Pablo Sanchez using the email address: pablo [dot] sanchez-martin [at] tuebingen.mpg.de)

 2.  2nd assignment* (corresponding to Block II) due to January 17th.
